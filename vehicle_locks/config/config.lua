...
-- Alarm HUD (bell icon shown to the vehicle owner when their alarm triggers)
Config.AlarmHudEnabled            = false
...
-- Interior Lock (G key, from inside the vehicle — cars only)
Config.InteriorLockSoundLock      = "doorlock"    -- OGG file in html/sounds/ (no extension)
Config.InteriorLockSoundUnlock    = "doorunlock"  -- OGG file in html/sounds/ (no extension)
Config.InteriorLockSoundVolume    = 0.48          -- 0.0 – 1.0  (volume heard inside the vehicle)
Config.InteriorLockOutsideReach   = 6             -- metres  (how far the muffled click carries outside)
Config.InteriorLockOutsideVolume  = 0.22          -- 0.0 – 1.0  (volume heard by players outside)
Config.InteriorLockMuffleFreq     = 350           -- Hz  lowpass cutoff applied to the outside-heard version
...
-- Key binding defaults (rebindable in FiveM settings → Key Bindings → FiveM)
