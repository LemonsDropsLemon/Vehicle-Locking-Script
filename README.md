...
Vmenu type server Vehicle Locking Script for better RP, can be used on more than vmneu servers

This script hooks onto the first driving inside of a car, and gives them "keys" only allowing that one person access to that one car for locking and unlocking controls.
